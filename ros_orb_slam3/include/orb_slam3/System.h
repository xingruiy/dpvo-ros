...
public:
    ...
    System(std::string node_name="orb_slam3");

    void InitializeRos();
    cv::Mat GetImageFromMsg(const sensor_msgs::msg::Image::ConstPtr &img_msg);
    void SetCurrentCameraPose(const Sophus::SE3f& pose);
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr mLocalMapPublisher;
    rclcpp::Publisher<geometry_msgs::msg::PoseArray>::SharedPtr mKeyFramePublisher;
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr mCovizGraphPublisher;
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr mOdometryPublisher;
    rclcpp::TimerBase::SharedPtr mPosePubTimer;
    rclcpp::TimerBase::SharedPtr mMapPubTimer;
    rclcpp::TimerBase::SharedPtr mTrackingTimer;

    void ImgCallback(const sensor_msgs::msg::Image::SharedPtr img_msg);
    void DepthCallback(const sensor_msgs::msg::Image::SharedPtr img_msg);
    std::mutex mMutexBuffer;
    std::mutex mMutexIMU;
    std::vector<IMU::Point> mQueueImuBuffer;
    std::queue<sensor_msgs::msg::Image::ConstPtr> mImageBuffer;
    std::queue<sensor_msgs::msg::Image::ConstPtr> mDepthBuffer;
    void SyncImageAndDepth();
...
private:
    ...
    typedef message_filters::sync_policies::ApproximateTime<
        sensor_msgs::msg::Image, sensor_msgs::msg::Image> SyncPolicyImageDepth;
    std::shared_ptr<message_filters::Synchronizer<SyncPolicyImageDepth>> mImageDepthSync;
    const int mMessageQueueSize = 100;
    ...
    rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr mKeyFramePub;

    std::string mStrSettingsFile;
